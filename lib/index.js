...
module.exports = {
  ...
  async getAppTicket() {
    try {
      ...
      setTimeout(module.exports.reissueAppTicket, result.exp - Date.now() - 10000);
      return module.exports.appTicket = result;
    } catch(ex) {
      console.error(ex);
      setTimeout(module.exports.getAppTicket, 1000 * 60 * 5);
  ...
  async reissueAppTicket() {
    try {
      ...
      setTimeout(module.export.reissueAppTicket, result.exp - Date.now() - 10000);
      return module.exports.appTicket = result;
    } catch(ex) {
      console.error(ex);
      setTimeout(module.export.getAppTicket, 1000 * 60 * 5);
      return module.exports.appTicket = null;
    }
  },
